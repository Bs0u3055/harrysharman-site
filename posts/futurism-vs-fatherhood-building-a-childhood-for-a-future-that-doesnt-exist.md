...
**Social Navigation:** Collaboration, leadership, disagreement. It’s about learning the art of friction: how to make things with other messy, unpredictable humans. *(It takes us back to our evolutionary roots: the ***[Social Brain hypothesis](https://pubmed.ncbi.nlm.nih.gov/19575315/)* suggests that social complexity is what drove human intelligence in the first place.)* It also means modeling new norms, like the visibility the [Parenting Out Loud](https://www.linkedin.com/company/parenting-out-loud/) movement champions for fathers.
